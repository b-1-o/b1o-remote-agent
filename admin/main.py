...
<style>
:root{color-scheme:dark;font-family:Inter,ui-sans-serif,system-ui,-apple-system,sans-serif;background:#080a0e;color:#f2f5f8}
*{box-sizing:border-box}body{margin:0;min-height:100vh;background:radial-gradient(900px 500px at 20% -10%,#1c2735 0,transparent 55%),radial-gradient(700px 400px at 100% 0,#161d27 0,transparent 55%),#080a0e}
.shell{display:grid;grid-template-columns:230px 1fr;min-height:100vh}.side{padding:24px 16px;border-right:1px solid #202731;background:#0d1117cc;backdrop-filter:blur(18px);position:sticky;top:0;height:100vh}
.brand{font-weight:800;font-size:20px;padding:8px 10px 22px}.brand span{color:#8fa6ff}.nav{display:grid;gap:8px}.nav button{width:100%;text-align:left}
.nav button.active{background:#eef2f7;color:#101318}.content{padding:30px;max-width:1250px;width:100%}.top{display:flex;justify-content:space-between;align-items:end;margin-bottom:22px}
...
.card{background:#11161dcc;border:1px solid #252e38;border-radius:20px;padding:20px;box-shadow:0 18px 60px #0006;margin-bottom:16px}.card h2{margin:0 0 6px;font-size:18px}
...
.row{display:flex;gap:9px;flex-wrap:wrap;align-items:center}.spaced{margin-top:14px}.btn{border:1px solid #303b47;background:#171e27;color:#f2f5f8;border-radius:10px;padding:10px 13px;cursor:pointer}.btn:hover{filter:brightness(1.08)}.btn.primary{background:#eef2f7;color:#11151b}.btn.danger{background:#35181d;border-color:#5e2a31}
.pill{padding:5px 9px;border-radius:999px;font-size:12px;background:#151c24;border:1px solid #2a3540}.ok{color:#8de3a5}.warn{color:#f1ca75}
